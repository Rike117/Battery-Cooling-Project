...
function[total_field_time,up_time,total_flight_time,Total_Cost] = Battery_Sim_C2(num_batteries,num_chargers_2,min_flight_time,Charger_Cost,Battery_Cost,Work_Cost);
...
%% Print Outputs
Total_Cost = (num_batteries*Battery_Cost)+(num_chargers_2*Charger_Cost)+(Work_Cost);
